...
//        self.collectionView!.register(CoffeeShopCollectionViewCell.self, forCellWithReuseIdentifier: reuseIdentifier)
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> CoffeeShopCollectionViewCell {
        ...
        let coffeeShop = CoffeeShop.all[indexPath.item]
